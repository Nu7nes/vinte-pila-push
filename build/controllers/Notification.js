...
var PushNotification = /** @class */ (function () {
    ...
    PushNotification.prototype.init = function () {
        web_push_1.default.setVapidDetails("https://localhost:3000", this.publicKey, this.privateKey);
    };
    PushNotification.prototype.sendKey = function (req, res) {
        res.json({ publicKey: this.publicKey });
    };
    PushNotification.prototype.registerSub = function (req, res) {
        console.log(req.body);
        // RedisClient.updateValue("subscription", JSON.stringify(req.body));
        return res.status(201).json({ data: req.body });
    };
    PushNotification.prototype.sendPush = function (req, res) {
