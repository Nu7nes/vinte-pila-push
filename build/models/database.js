...
var RedisConnection = /** @class */ (function () {
    ...
    RedisConnection.getInstance = function () {
        if (!RedisConnection.instance) {
            RedisConnection.instance = new RedisConnection();
        }
        return RedisConnection.instance;
    };
    RedisConnection.prototype.getValue = function (key) {
    ...
    RedisConnection.prototype.updateValue = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = RedisConnection.getInstance();
